...
<head>
    ...
    <meta name="title" content="Citra & Ardian">
    <meta name="description" content="Landing page wedding personal Citra & Ardian">
    <meta name="keywords" content="Citra & Ardian, wedding, wedding invitation, villa lagenta">
    <meta name="author" content="Salman">
    <meta name="robots" content="index, follow">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=5">
    <meta name="format-detection" content="telephone=no">
    <title>Citra & Ardian</title>
        ...
        <div id="my_id" uk-modal="" bg-close="false" class="uk-modal uk-flex uk-open" tabindex="0">
            ...
            ">
                ...
                <div class="@if (request()->has('name')) tw-mt-20 @else tw-mt-24 @endif tw-text-center">
                    ...
                    @if (request()->has('name'))
                        <h2 class="yn-color tw-mt-4"
                            style="line-height:1; margin-bottom:9px !important; font-size:28px;">
                            {{ request()->get('name') }} </h2>
                    @else
                        <div class="tw-mb-3"></div>
                    @endif
                    <p class="uk-text-medium txt-simple">Anda Diundang <br>Di Pernikahan Kami</p>
                </div>

                <div class="tw-mt-20">
                    <button id="play-sound"
                        class="uk-modal-close tw-bg-white tw-text-gray-600 tw-text-xs tw-tracking-widest tw-py-2 tw-px-4 tw-rounded-lg tw-w-3/5"
                        type="button">OPEN INVITATION</button>
                </div>
